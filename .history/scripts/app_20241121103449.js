...
app.use(express.static(path.join(__dirname, '../scripts'))); // Folder 'public' untuk file statis
...
app.get('/', (req, res) => {
  res.sendFile(path.join(__dirname, '../views', 'about.html')); // Halaman signup
});

// Rute untuk halaman home
app.get('/', (req, res) => {
  res.sendFile(path.join(__dirname, '../views', 'index.html')); // Halaman home
});
