...
app.get('/addRecipes.html', checkLogin, (req, res) => {
  res.sendFile(path.join(__dirname, 'addRecipe.html'));
});

app.get('/searchrecipes.html', checkLogin, (req, res) => {
  res.sendFile(path.join(__dirname, 'searchrecipe.html'));
});
...
function checkLogin(req, res, next) {
  if (!req.session.user) { // Jika session user tidak ada (belum login)
